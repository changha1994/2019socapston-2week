...
String apiKey = "TRU52JXKXOYVG47B";     //  Enter your Write API key from ThingSpeak
const char* ssid =  "j";     // Enter your WiFi Network's SSID
const char* pass =  "12342345"; // Enter your WiFi Network's Password
